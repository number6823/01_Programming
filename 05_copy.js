...
//  실제로 Heap 메모리 영역에 저장되는 값은 실제 값이 아니라 "주소값이"이기 때문.
...
console.log(sCopyUser);

var dCopyUser = {                 // 객체를 새로 만들고, 그 안의 값들을 복사햐주는 복사
...
// var dUser3 = {          // 객체 안에 동일한 key를 갖고 있는 프로퍼티가 있다면, 덮어쓰기됨
//     name: oUser2.name,
//     age: oUser2.age,
//     address: oUser2.address,
//     address: {
